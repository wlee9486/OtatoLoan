...
<div class="test">
    <div class="container test2">
        <div class="item1">
            <div class="ctitle">회원가입</div>

            <div class="root"><a class="aline" href="<%=cp%>/web/main2.jsp"> HOME </a> > 회원가입</div>
        </div>
        ...
        <div class="item2">
            <div class="scontainer">
                <h4 class="mainheader" ;><b>CREATE ACCOUNT</b></h4>
                <hr class="hr-3">
                <br/>
            </div>

            <form action="<%=cp%>/login/signup_ok.do" class="validation-form" novalidate method="post" name="myForm"
                  style="background-color: #fff; padding: 20px;">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <font style="font-family: 'OTWelcomeRA'; font-size: 15pt;">성명</font>
                        <input type="text" class="form-control" id="name" name="userName" placeholder="이름" value=""
                               required
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="password" class="form-control" id="password" name="userPwd" placeholder="비밀번호"
                               value=""
                               required>
                        <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" name="userEmail" id="email"
                           placeholder=" 이메일 [you@example.com]" required
                           style="font-family: 'OTWelcomeRA'; font-size: 14pt;">
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="radio" name="gender" value="남"/><font
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-1">
                        <select class="form-select" id="inputGroupSelect01" name="carrier" required
                            ...
                            <option value="" disabled selected style="font-family: 'OTWelcomeRA'; font-size: 14pt;">통신사
                                선택
                            </option>
                            <option>SKT</option>
                            <option>KT</option>
                        ...
                        <input type="text" class="form-control" id="tel" name="userTel" placeholder="휴대전화번호"
                ...
                <div class="row">
                    ...
                    <div class="custom-control custom-checkbox"
                        ...
                        <input type="checkbox" class="custom-control-input" id="agreement" name="marketingYn" value="Y">
